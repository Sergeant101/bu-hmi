...
namespace VFD_160
{
    public partial class App : SEApplication
    {
        ...
        protected override void OnHmiDataFileLoaded(HmiDataFile file)
        {
            ...
            var NodeNamesToDisable = new string[] { "multimetr1", "multimetr2", "write" };
            ...
            LoadTagsForReadies(file, @"\data\readies\");
            ...
            if (zakaz == ZakazType.zakaz54042 && plc != PlcType.Fastwel)
            {
                ...
                var fileName = Path.GetDirectoryName(uri.LocalPath.ToLower()) + Frames.MainFrame.RELATIVE_COMPLECTATION_FILE_PATH;
        ...
        private void LoadTagsForReadies(HmiDataFile hmiDataFile, string relativePath)
        {
            var uri = new Uri(Assembly.GetExecutingAssembly().GetName().CodeBase);
    ...
    {
        [Description("ЗАКАЗ 159")]
        zakaz54038,
        [Description("ЗАКАЗ 160")]
        zakaz54042
    }
