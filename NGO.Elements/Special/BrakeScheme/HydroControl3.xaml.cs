...
namespace NGO.Elements.Special.BrakeScheme
{
    ...
    /// </summary>
    public partial class HydroControl3 : UserControl
    {
        public HydroControl3()
        {
            InitializeComponent();
        }

        public static DependencyProperty openProperty =
            DependencyProperty.Register("open", typeof(bool), typeof(HydroControl3), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender, callback));
        ...
        private static void callback(DependencyObject dep_obj, DependencyPropertyChangedEventArgs dp_event_args)
        {
            ...
            var cntrl = (HydroControl3)dep_obj;
            if (val != null)
            {
                if (val)
                {
