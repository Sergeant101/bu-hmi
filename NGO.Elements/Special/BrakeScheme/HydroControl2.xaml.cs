...
namespace NGO.Elements.Special.BrakeScheme
{
    ...
    /// </summary>
    public partial class HydroControl2 : UserControl
    {
        public HydroControl2()
        {
            InitializeComponent();
        }

        public static DependencyProperty openProperty =
            DependencyProperty.Register("open", typeof(bool), typeof(HydroControl2), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender, callback));
        ...
        private static void callback(DependencyObject dep_obj, DependencyPropertyChangedEventArgs dp_event_args)
        {
            ...
            var cntrl = (HydroControl2)dep_obj;
            if (val != null)
            {
                if (val)
                {
